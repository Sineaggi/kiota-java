...
public class JdkHttpRequestAdapterTest {
    @ParameterizedTest
    @EnumSource(
    ...
    public void PostRequestsShouldHaveEmptyBody(HttpMethod method)
        ...
        final var adapter =
                new JdkHttpRequestAdapter(authenticationProviderMock) {
    ...
    void SendStreamReturnsUsableStream(int statusCode) throws Exception {
        ...
        final var requestAdapter =
                new JdkHttpRequestAdapter(authenticationProviderMock, null, null, client);
    ...
    public void SendReturnsObjectOnContent(int statusCode) throws Exception {
        ...
        final var requestAdapter =
                new JdkHttpRequestAdapter(authenticationProviderMock, mockFactory, null, client);
        final var response = requestAdapter.send(requestInformation, null, (node) -> mockEntity);
        assertNotNull(response);
    }
